...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BCcI129A.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-BhMZJInU.js', import.meta.url).href),import:true},'@apollo/client':{get:()=>()=>__federation_import(new URL('__federation_shared_@apollo/client-DRdVvpB_.js', import.meta.url).href),import:true},'graphql':{get:()=>()=>__federation_import(new URL('__federation_shared_graphql-BGbysoV6.js', import.meta.url).href),import:true}};
